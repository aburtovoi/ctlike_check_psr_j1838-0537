...
'''
cube = gammalib.GCTAObservation('../cntcube_0.03_100_FOV_4.0_binsz_0.02_GAL.fits')  # modAB
cube.response(gammalib.GCTACubeExposure('../expcube_0.03_100_FOV_4.0_binsz_0.02_GAL.fits'),
              gammalib.GCTACubePsf('../psfcube_0.03_100_FOV_4.0_binsz_0.02_GAL.fits'),
              gammalib.GCTACubeBackground('../bkgcube_0.03_100_FOV_4.0_binsz_0.02_GAL.fits'))  # modAB
